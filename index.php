...
<head>
    ...
    <link rel="stylesheet" href="<?= $DomainUrlFullPath ?>/assets/css/tailwind.min.css"/>
    <link rel="stylesheet" href="<?= $DomainUrlFullPath ?>/assets/css/style.css"/>
</head>
    ...
    <div class="container px-5 py-24 mx-auto">
        ...
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <div class="flex flex-wrap -m-2">
                ...
                >
                    <a class="text-indigo-400">ardaltunelmain@gmail.com</a>
...
<script src="<?= $DomainUrlFullPath ?>/assets/js/jquery.min.js"></script>
<script src="<?= $DomainUrlFullPath ?>/assets/js/app.js"></script>
</body>
</html>
